#pragma once
#include <banshee/parser.h>
#include <banshee/json/json_lexer.h>
#include <banshee/property.h>
#include <stack>
#include <optional>
...
class json_parser : public parser_base<JsonLexer> {
public:
    using parser_base<JsonLexer>::parser_base;
    using Token = typename JsonLexer::Token;
    using TK = typename Token::TokenKind;

    using property = banshee::basic_property<banshee::details::types<char>>;
    using maybe_property = std::optional<property>;
